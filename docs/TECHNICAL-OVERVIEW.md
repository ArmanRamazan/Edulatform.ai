...
| Payment Service | ✅ Готов | Mock-оплата, Stripe SDK adapter, subscription_plans + user_subscriptions, teacher_earnings, payouts, coupons/promo codes, invoice PDF generation, refunds (admin approval workflow), GET /me, GET /:id, GET /earnings/me, POST /payouts/request |
...
| Unit Tests | ✅ 625 тестов | identity 63, course 111, enrollment 28, payment 128, notification 38, ai 116, learning 137 (incl. pre-test: 20, velocity: 11), +4 coupon endpoints |
...
├── services/py/payment/     — Payment: mock-оплата, teacher earnings, payouts, invoice PDF, refunds
