...
|-----------|--------|----------|
| Identity Service | ✅ Готов | Регистрация, логин, JWT refresh tokens, роли, admin, email verification, forgot password, referral program |
...
| Unit Tests | ✅ 649 тестов | identity 64, course 111, enrollment 28, payment 151, notification 38, ai 116, learning 137 (incl. pre-test: 20, velocity: 11), +4 coupon endpoints |
...
├── services/py/identity/    — Auth: register, login, JWT refresh tokens, roles, admin, email verification, referrals
