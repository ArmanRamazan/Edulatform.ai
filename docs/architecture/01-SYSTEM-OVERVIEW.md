...
**Метрики:** 81 endpoint, 26 таблиц в 6 БД, 400 тестов, 157 RPS (p99 51ms).
...
| Notification | 5 | 2 | 32 | POST (log to stdout), GET /me, PATCH /:id/read, POST /streak-reminders/send (admin), POST /flashcard-reminders/send (admin) |
...
| Learning Engine | 30 | 11 | 107 | Quizzes (4), Flashcards+FSRS (4), Concepts/Knowledge Graph (7), Streaks (2), Leaderboard (5), Discussions (5), XP (1), Badges (1) |

**Итого:** 81 endpoint, 26 таблиц, 400 тестов
