...
**Метрики:** ~133 endpoints, ~49 таблиц в 7 БД, ~948 тестов.
...
|----------|--------|---------------|
| API Gateway | ~~Не нужен~~ → Scaffolded: Rust/Axum :8080, health checks, config, error handling | Sprint 23 (in progress) |
