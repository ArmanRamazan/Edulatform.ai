...
| Learning Engine | 35 | 14 | 147 | Quizzes (4), Flashcards+FSRS (4), Concepts/Knowledge Graph (7), Streaks (2), Leaderboard (5), Discussions (5), XP (1), Badges (1), Adaptive Pre-test (3), Velocity (1), Activity Feed (2) |
