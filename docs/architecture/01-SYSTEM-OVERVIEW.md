...
|----------|--------|---------------|
| API Gateway | ~~Не нужен~~ → Rust/Axum :8080, JWT verification, Redis sliding window rate limiting, reverse proxy routing to Python services, health checks | Sprint 23 (in progress) |
