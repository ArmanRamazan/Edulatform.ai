...
│  │  JWT, Rate Limit │  │ tantivy FTS  │ batch embed │ real-time │     │
...
| Notification | ~9 | 3 | 57 | POST (email stub), GET /me, PATCH read, streak/flashcard reminders, direct messaging (conversations + messages), **WS gateway push** (fire-and-forget real-time delivery) |
...
Notification ──HTTP──▶ WS Gateway        (real-time push, fire-and-forget)
