...
| Learning Engine | 41 | 16 | 161 | Quizzes (4), Flashcards+FSRS (4), Concepts/Knowledge Graph (7), Streaks (2), Leaderboard (5), Discussions (5), XP (1), Badges (1), Adaptive Pre-test (3), Velocity (1), Activity Feed (2), Study Groups (6) |

**Итого:** 89 endpoint, 29 таблиц, 625 тестов
