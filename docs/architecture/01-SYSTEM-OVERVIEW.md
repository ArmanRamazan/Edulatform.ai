...
│  │  JWT, Rate Limit │  │ RAG Chunker (pyo3 FFI, no port)        │     │
│  └────────┬─────────┘  └─────────────────────────────────────────┘     │
│            │              (Sprint 23-25, planned)                       │
│                                                                        │
├────────────┼────────────────────────────────────────────────────────────┤
...
| Search Service (Rust/tantivy) | 8010 | HTTP/REST |
...
|----------|--------|---------------|
| API Gateway | ~~Не нужен~~ → Запланирован: Rust/Axum :8080 (ADR-010) | Sprint 23 |
