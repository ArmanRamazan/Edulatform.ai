...
import { ExternalLink, BookmarkPlus, AlertCircle, RefreshCw } from "lucide-react";
...
export function ExternalResultsSection({
  ...
  return (
    <div className="space-y-3">
      ...
      {/* Loading — shimmer matching card shape */}
      {isLoading && (
        <div className="space-y-3" aria-busy="true" aria-label="Searching the web">
          {[1, 2, 3].map((i) => (
            <Card key={i} className="overflow-hidden border-[#2a2a3e] bg-[#14141f]">
              <CardContent className="p-4">
                ...
                <div className="relative mt-1 h-3 w-1/2 overflow-hidden rounded bg-[#1a1a2e]">
                  <div className="absolute inset-0 animate-shimmer" />
                </div>
              </CardContent>
            </Card>
