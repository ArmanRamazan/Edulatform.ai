...
- **508 unit-тестов**, нагрузочное тестирование через Locust
- **82 endpoint**, **26 таблиц** в 6 БД
...
**Phase 3.2 — Monetization backend (завершён).** 7 сервисов, 83 endpoint, 508 тестов. AI-слой: quiz generation, summary, Socratic tutor, study plan. Learning Engine: квизы + FSRS flashcards + knowledge graph + gamification. Buyer App: 18 страниц (каталог, обучение, AI, геймификация, onboarding). Stripe backend: subscriptions, earnings, payouts.
